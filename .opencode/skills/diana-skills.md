...
Orquesta /diana.skills para generar, validar o regenerar skills canonicas por scope y layer, con trazabilidad a fuentes oficiales y mapeo por agentes/engines.

## When to use

Use this skill when the user wants to generate, validate or regenerate canonical skills for a Diana project, ensuring traceability to official sources and mapping by agents/engines.
...
- Priorizar trazabilidad canonica y compatibilidad de IDs.
...
1. Toda skill debe trazarse a fuente canonica (source_of_truth).
2. Toda skill debe enlazar knowledge_docs existentes o por crear.
3. Toda etapa Speckit debe definir required_skills minimas:
   - speckit.specify
   - speckit.clarify
   - speckit.plan
   - speckit.tasks
...
5. Si una skill canonica no existe, crearla.
...
9. Convencion obligatoria de IDs de skill: `<NNN>-inv-<skill-name-predictivo-en-minusculas>`.
...
4. Evitar duplicar skills de frameworks/metodologias generales por proyecto.
...
- Que no existan skills huerfanas sin agente/etapa usuaria.
...
## Integracion con /diana.knowledge
...
/diana.knowledge debe usar skills-manifest.yaml y agent-skill-matrix.yaml como entrada obligatoria de contexto antes de investigacion profunda.
